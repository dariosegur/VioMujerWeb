...
namespace VioMujerWeb.Controllers
{
    public class BaseController : Controller
    {
        ...
        protected override void OnAuthentication(AuthenticationContext filterContext)
        {
            var controllerName = (string)filterContext.RouteData.Values["controller"];
            var actionName = (string)filterContext.RouteData.Values["action"];
            if (controllerName == "Home" && actionName == "Autenticar") return;
        ...
        {
            get { return (bool)(HttpContext.Session["EstaAutenticado"] ?? false); }
            set { HttpContext.Session["EstaAutenticado"] = value; }
        }
        ...
        {
            get { return (Negocio.Usuario)(HttpContext.Session["UsuarioActual"] ?? false); }
